...
from neural_style_logic.encoder_adain import Encoder
from neural_style_logic.decoder_adain import Decoder
from neural_style_logic.adaptive_instance_norm import AdaIN

MODEL_SAVE_PATHS = "neural_style_logic/models/style_weight_2e0.ckpt"
